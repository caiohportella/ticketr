...
import { downloadTicketData, shareTicket } from "@/lib/ticket";
        ...
        <div className="mb-8 space-y-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <button
                onClick={() => downloadTicketData(ticket as TicketWithEvent)}
              ...
              <button
                onClick={() => shareTicket(ticket as TicketWithEvent)}
                className="flex items-center gap-2 px-4 py-2 text-gray-600 hover:text-gray-900 transition-colors rounded-lg hover:bg-gray-100"
              >
