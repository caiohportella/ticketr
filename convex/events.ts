...
export const getTicketAvailability = query({
  ...
  handler: async (ctx, { eventId }) => {
    ...
    return { purchasedTicketsCount, activeOffers };
  },
});
...
export const getEventAvailability = query({
  ...
  handler: async (ctx, { eventId }) => {
    ...
    const { purchasedTicketsCount, activeOffers } = await getTicketAvailability(
      ctx,
      {
        eventId,
      }
...
export const checkAvailability = query({
  ...
  handler: async (ctx, { eventId }) => {
    ...
    const availableSpots =
      event.totalTickets - (purchasedTicketsCount + activeOffers);
